...
def build_models(
    ...
    pool: list[tuple[str, callable]] = [
        ...
        ("ctc-nat-30m-bunsetsu-v3-best",
            lambda: _ctc("models/checkpoints/ctc-nat-30m-bunsetsu-v3/best.pt")),
        ("ctc-nat-30m-bunsetsu-v3-step60000",
            lambda: _ctc("models/checkpoints/ctc-nat-30m-bunsetsu-v3/checkpoint_step_60000.pt")),
        ("ctc-nat-30m-bunsetsu-v3-step70000",
