...
def main() -> None:
    ...
    default_ckpts = {
        "ctc_nat_30m": "models/checkpoints/ctc-nat-30m-scratch/checkpoint_step_50000.pt",
        "ctc_nat_90m": "models/checkpoints/ctc-nat-90m-scratch/checkpoint_step_27500.pt",
    }
