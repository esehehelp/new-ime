...
def build_models(filter_substr: str = "",
    ...
    pool = [
        ...
        ("ctc_nat_30m-step50000",
            lambda: _ctc("models/checkpoints/ctc-nat-30m-scratch/checkpoint_step_50000.pt")),
        ("ctc_nat_30m-final",
        ...
        ("ctc-nat-30m-student-step49000",
            lambda: _ctc("models/checkpoints/ctc-nat-30m-student/checkpoint_step_49000.pt")),
        ("teacher-150m-teacher-step100000",
