...
from datasets.datasets.tools.probe.run import evaluate
...
def main():
    ...
    ap.add_argument("--out", default="results/probe_chunk_sweep/summary.json")
    ...
    ckpt_v2 = "models/checkpoints/ctc-nat-30m-student/best.pt"
    ckpt_v1 = "models/checkpoints/ctc-nat-30m-scratch/best.pt"
