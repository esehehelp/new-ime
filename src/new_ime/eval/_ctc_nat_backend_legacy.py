...
from new_ime.eval.ctc_beam import prefix_beam_search
...
class CTCNATBackend(ConversionBackend):
    def __init__(
        ...
        if lm_paths_by_domain and (self.lm_alpha > 0.0 or self.lm_beta > 0.0):
            from new_ime.eval.kenlm_mixture import CategoryEstimator, KenLMMixtureScorer
            ...
            from new_ime.eval.kenlm_scorer import KenLMCharScorer
