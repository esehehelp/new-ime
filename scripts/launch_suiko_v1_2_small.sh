#!/usr/bin/env bash
# Launch Suiko-v1.2-small (phase3_30m, ~30M params). Cost-efficient
# variant of v1.2-medium for faster iteration on local 3060.
#
# Hyperparams diff vs medium:
#   - preset:  phase3_90m  -> phase3_30m
#   - lr:      2e-4        -> 3e-4   (smaller model can take a higher LR)
#   - output:  Suiko-v1.2-medium -> Suiko-v1.2-small
# everything else (KD schedule, refine, cvae, max_steps) identical.
set -eu
