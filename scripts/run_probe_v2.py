...
Reads datasets/probe_v2/probe.tsv (category, reading, expected_surface) and
...
def build_models(filter_substr: str = "",
    ...
    pool = [
        ...
        ("ctc_nat_30m-best",
            lambda: _ctc("models/checkpoints/ctc_nat_local_30m_fast_kd/best.pt")),
        ("ctc_nat_30m-step50000",
            lambda: _ctc("models/checkpoints/ctc_nat_local_30m_fast_kd/checkpoint_step_50000.pt")),
        ("ctc_nat_30m-final",
            lambda: _ctc("models/checkpoints/ctc_nat_local_30m_fast_kd/final.pt")),
        ("ctc_nat_90m-step27500",
            lambda: _ctc("models/checkpoints/vast_mirror/ctc_nat_90m_phase3mix/checkpoint_step_27500.pt")),
    ]
    if filter_substr:
...
def main() -> None:
    ...
    ap.add_argument("--probe", default="datasets/probe_v2/probe.tsv")
