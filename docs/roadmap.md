...
|-------|------|
| Phase 0 (設計) | **完了** |
| Phase 1 (データパイプライン) | **完了** (Wiki+青空+Livedoor+Tatoeba, 20.8M ペア, 100M チャンク) |
| Phase 2 (AR ベースライン) | **完了** (31.9M, manual 80%, eval_v3 EM 0.412) |
| Phase 3 (CTC-NAT 本体) | 未着手 |
| Phase 4 (評価・改善) | 評価基盤構築済、改善サイクル未着手 |
| Phase 5 (fcitx5/Windows 統合) | **Windows DLL 動作確認済** / fcitx5 未ビルド |
| Phase 6 (量子化・CVAE) | 未着手 |
...
| エンコーダ初期化 | cl-tohoku/bert-japanese | **cl-tohoku/bert-base-japanese-char-v3** |
| 候補生成 | 未定 | **CTC beam search + KenLM shallow fusion** |
| 出力語彙 | SentencePiece BPE 32k | **文字単位 ~6000** |
| MeCab feature | features[7/9] | **features[17]** (仮名形出現形) |
| パラメータ規模 | 100M | **135M (拡張想定 200M)** |
...
Week 9-16    : Step 3 — CTC-NAT 本体 (ここが山場)  ← 現在ここ
Week 17-22   : Step 4 — 評価・改善サイクル
Week 23-28   : Step 5 — ONNX + fcitx5/Windows 統合
```
