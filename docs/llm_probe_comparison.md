...
| 4 | **zenz-v3.1-small** | **0.7213** | **~94M** | IME AR | n/a | HF (local) |
...
| 13 | DeepSeek V4-Flash thinking | 0.644† | 671B/37B-act | LLM open | yes | DeepSeek |
...
- 94M zenz が **357B GLM-5.1 thinking (0.692) を 3pt 上回り、235B Qwen3-Instruct を 28pt 上回る**
...
- **総合 0.678** — 235B Qwen3-Instruct (0.451) を **+23pt** 上回り、31B Gemma 4 (0.675) と同水準、357B GLM-5.1 thinking (0.692) からは ‑1.4pt
